<div class="row">
    {$message}
    <div class="col-md-12">
        <form id="form" action="{$SERVER_ADMIN}seccion/vocacional/nuevo" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="txt_voc_nombre" id="txt_voc_nombre" class="form-control" required value="" maxlength="150" data-plugin-maxlength=""/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="summernote" data-plugin-summernote data-plugin-options='{literal}{"id_textarea":"txt_voc_descripcion", "height": 180, "codemirror": { "theme": "ambiance" } }{/literal}'></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">2° Contenido <span class="required">*</span></label>
                        <div class="col-sm-9">
                            <div class="summernote" data-plugin-summernote data-plugin-options='{literal}{"id_textarea":"txt_voc_descripcion_2", "height": 180, "codemirror": { "theme": "ambiance" } }{/literal}'></div>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="input-append">
                                    ...
                                    <span class="btn btn-default btn-file">
                                        ...
                                        <input type="file" name="txt_voc_imagen" id="txt_ss_imagen"/>
                                    </span>
