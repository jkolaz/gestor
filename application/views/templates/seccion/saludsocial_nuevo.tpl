<div class="row">
    {$message}
    <div class="col-md-12">
        <form id="form" action="{$SERVER_ADMIN}seccion/saludsocial/nuevo" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="txt_ss_nombre" id="txt_ss_nombre" class="form-control" required value="" maxlength="50" data-plugin-maxlength=""/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="summernote" data-plugin-summernote data-plugin-options='{literal}{"id_textarea":"txt_ss_descripcion", "height": 180, "codemirror": { "theme": "ambiance" } }{/literal}'></div>
                        </div>
                    </div>
                    <div class="form-group">
