                    ...
                    <table class="table mb-none">
                        ...
                        {if $objTA|@count gt 0}
                            ...
                            <tr class="active">
                                ...
                                <td class="actions">
                                    <a href="{$SERVER_ADMIN}configuracion/tipoAdmin/editar/{$objTA[tipo]->ta_id}" title="Editar {$objTA[tipo]->ta_nombre}">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a class="delete-row" href="" title="Eliminar {$objTA[tipo]->ta_nombre}">
