            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="txt_sed_direccion" id="txt_sed_direccion" class="form-control" maxlength="100" data-plugin-maxlength="" required />
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="txt_sed_correo" id="txt_sed_correo" class="form-control" maxlength="100" data-plugin-maxlength="" required />
                            <p><code>Máximo</code> 100.</p>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="txt_sed_visita" id="txt_sed_visita" maxlength="250" data-plugin-maxlength="" required rows="3"></textarea>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="txt_sed_consulta_lv" id="txt_sed_consulta_lv" maxlength="50" data-plugin-maxlength="" required rows="2"></textarea>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="txt_sed_consulta_s" id="txt_sed_consulta_s" maxlength="50" data-plugin-maxlength="" required rows="2"></textarea>
                            <p><code>Máximo</code> 50.</p>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="txt_sed_farmacia_lv" id="txt_sed_farmacia_lv" maxlength="50" data-plugin-maxlength="" required rows="2"></textarea>
                            <p><code>Máximo</code> 50.</p>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="txt_sed_farmacia_s" id="txt_sed_farmacia_s" maxlength="50" data-plugin-maxlength="" required rows="2"></textarea>
                            <p><code>Máximo</code> 50.</p>
                        </div>
                    </div>
                </div>
