        ...
        <section class="panel">
            <div class="panel-body">
                <div class="thumb-info mb-md">
                    <img src="{$DIR_PRINCIPAL}assets/images/!logged-user.jpg" class="rounded img-responsive" alt="John Doe">
                    <div class="thumb-info-title">
                        <span class="thumb-info-inner">{$datos_usuario[0]->PER_Nombre}</span>
                        <span class="thumb-info-type">{$datos_usuario[0]->ROL_Descripcion}</span>
                    </div>
                </div>
                ...
                <div class="widget-toggle-expand mb-md">
                    ...
                    <div class="widget-content-expanded">
                        <ul class="simple-todo-list">
                            <li class="">Cambiar Foto de Pelfil</li>
                ...
                <h6 class="text-muted">Acerca de mí</h6>
                    ...
                    <ul class="simple-user-list">
                        <li>
                            <figure class="image rounded">
                                <img src="{$DIR_PRINCIPAL}assets/images/!sample-user.jpg" alt="Joseph Doe Junior" class="img-circle">
                            </figure>
                        ...
                        <li>
                            <figure class="image rounded">
                                <img src="{$DIR_PRINCIPAL}assets/images/!sample-user.jpg" alt="Joseph Junior" class="img-circle">
                            </figure>
                        ...
                        <li>
                            <figure class="image rounded">
                                <img src="{$DIR_PRINCIPAL}assets/images/!sample-user.jpg" alt="Joe Junior" class="img-circle">
                            </figure>
                ...
                <ul class="simple-post-list">
                    <li>
                        <div class="post-image">
                            <div class="img-thumbnail">
                                <a href="#">
                                    <img src="{$DIR_PRINCIPAL}assets/images/post-thumb-1.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="post-info">
                    ...
                    <li>
                        <div class="post-image">
                            <div class="img-thumbnail">
                                <a href="#">
                                    <img src="{$DIR_PRINCIPAL}assets/images/post-thumb-2.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="post-info">
                    ...
                    <li>
                        <div class="post-image">
                            <div class="img-thumbnail">
                                <a href="#">
                                    <img src="{$DIR_PRINCIPAL}assets/images/post-thumb-3.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="post-info">
                                ...
                                <li>
                                    <div class="tm-box">
                                        ...
                                        <div class="thumbnail-gallery">
                                            <a class="img-thumbnail lightbox" href="{$DIR_PRINCIPAL}assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                                <img class="img-responsive" width="215" src="{$DIR_PRINCIPAL}assets/images/projects/project-4.jpg">
                                                <span class="zoom">
                    ...
                    <form class="form-horizontal" method="get">
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="profileFirstName" name="profileFirstName" value="{$datos_usuario[0]->PER_Nombre}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="profileLastName1">Apellido Paterno</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="profileLastName1" name="profileLastName1" value="{$datos_usuario[0]->PER_Paterno}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="profileLastName2">Apellido Materno</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="profileLastName2" name="profileLastName2" value="{$datos_usuario[0]->PER_Materno}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="profileAddress">Foto</label>
                                <div class="col-md-8">
                                    <input type="file" class="" id="profileAddress" id="profileAddress">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="email" name="email" value="{$datos_usuario[0]->USU_correo}">
                                </div>
                            </div>
                        </fieldset>
